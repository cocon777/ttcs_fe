...
const StudentResultView = ({ resultData }) => {
    ...
    return (
        <div className="result-card" style={{ border: '1px solid #ccc', padding: '20px', borderRadius: '8px' }}>
            <h2>Kết quả bài kiểm tra</h2>
            <p><strong>Điểm số:</strong> {resultData.totalScore} / 10</p>
            ...
            <div className="feedback-section" style={{ backgroundColor: '#eef8fa', padding: '15px', borderRadius: '5px' }}>
                <h3>👩‍🏫 Nhận xét từ Giáo viên</h3>
                <p>
                    {/* Logic kiểm tra: Nếu có nhận xét thì in ra, nếu rỗng hoặc null thì in chữ in nghiêng */}
                    {resultData.teacherFeedback && resultData.teacherFeedback.trim() !== '' ? (
