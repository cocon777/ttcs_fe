        ...
        {danhSachBaiGiang.length === 0 ? (
          <div className="bg-white p-8 rounded-lg shadow text-center">
            <p className="text-gray-500 text-lg">
              Thầy cô chưa giao bài giảng nào cho lớp này.
            </p>
          </div>
        ) : (
              ...
              >
                ...
                {baiGiangDangMo === (bg.id || index) && (
                  <div className="p-4 border-t border-gray-100 bg-gray-50/50">
                    ...
                    {(bg.danhSachFile || bg.fileBaiGiangs) &&
                    (bg.danhSachFile || bg.fileBaiGiangs).length > 0 ? (
                      <div className="mt-4 flex flex-col gap-2">
                        <span className="font-semibold text-gray-700">
                          📎 Tài liệu đính kèm:
                        </span>
                        {(bg.danhSachFile || bg.fileBaiGiangs).map(
                          (file: any, i: number) => (
                            <a
                              key={i}
