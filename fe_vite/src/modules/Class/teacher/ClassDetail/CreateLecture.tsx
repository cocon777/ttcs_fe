...
export default function FormBaiGiang({ classId, initialData, onSuccess }: FormBaiGiangProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      {/* TIÊU ĐỀ */}
      <div>
        <label className="block font-bold mb-1">Tiêu đề: <span className="text-red-500">*</span></label>
        <input 
          type="text" 
          required
          value={tieuDe} 
      ...
      <div className="border border-dashed border-gray-400 p-4 rounded bg-gray-50">
        <label className="block font-bold mb-2 text-gray-700">📎 Đính kèm tài liệu (Không bắt buộc)</label>
        ...
        <div>
          <label className="block text-sm mb-1">Đường dẫn (Link Google Drive, OneDrive...):</label>
          <input 
            type="url" 
            value={linkTaiLieu} 
